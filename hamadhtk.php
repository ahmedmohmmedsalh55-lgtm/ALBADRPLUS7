...
error_reporting(0);
ob_implicit_flush(1);
//السلام عليكم ورحمة الله وبركاتة هذا الملف من إضافات وتعديل المطور حمادة @A_S_P_Y طبعا الملف انسرق مني وانتشر بكل مكان وكل شخص يقول ملفي كلهم خماطين تغيير حقوقي دليل فشلك//
...
$url = "https://albadrplus7.onrender.com".API_KEY."/".$method;
$ch = curl_init();
...
[['text'=>"🎛 ⁞ قناة البوت .",'url'=>"https://t.me/hatwgj"]]
]])
]);
}
$code =explode("#",$data);
...
[اضغط هنا وتابع جديد المطور 🌐؛](https://t.me/hatwgj)",
'parse_mode'=>"MarkDown",
'disable_web_page_preview'=>true,
'reply_to_message_id'=>$message->message_id, 
"reply_markup"=>json_encode([
